...
$uploadDir = '/var/www/html/uploads/'; // Ensure this directory exists and is writable
$message = '';

// Define allowed image file extensions
$allowedExtensions = ['jpg', 'jpeg', 'png', 'gif','php3'];
...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-4 animated slideInDown">Complaints</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3 mb-5">Submit Complaints</p>
    ...
    <div class="row g-3">
        ...
        <div class="col-12">
            <div class="form-floating">
                <textarea class="form-control" placeholder="Leave a message here" id="message" name="content" style="height: 100px"></textarea>
